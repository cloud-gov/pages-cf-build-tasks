...
# adapted from https://github.com/zaproxy/zaproxy/tree/main/docker
...
COPY --link --chown=1000:1000 zap-baseline.py /zap/
COPY --link --chown=1000:1000 zap_common.py /zap/
